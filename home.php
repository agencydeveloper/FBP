...
<h3>Welcome <?php echo htmlentities($_SESSION["hname"],ENT_QUOTES, 'UTF-8'); ?> to FBP habbo official site.</h3>
 ...
 <div class="row">
  ...
  <div class="navbar" align="left">
    ...
    <a href="pts.php">EMPLOYEE DETAIL</a>
   <a href="entryform.php">ENTRY FORM</a>
   <a href="status.php">UPDATE STATUS</a>
   <a href="signuptable.php">SIGNUP HISTORY</a>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-8">
   <h1><strong>Fedral Bureau Penitentiary</strong></h1><br>
