...
<div class="alert">
  ...
  <strong>Thank You!</strong> the status is successfully updated.
</div>
<h3>Welcome <?php echo htmlentities($_SESSION["hname"],ENT_QUOTES, 'UTF-8'); ?> to MDF habbo official site.</h3>
